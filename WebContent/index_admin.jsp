...
<title>Comfy place (Admin page)</title>
...
<body>
	...
	<div class="button_cont" align="right"><a class="example_b" href="index.jsp" target="_blank" rel="nofollow noopener">
	Logout</a>
	</div>
	<div class="tm-container">
		<div class="tm-text-white tm-page-header-container">
			
			<i class="fas fa-heart fa-2x tm-page-icon" style="color: #ab8079; text-shadow: 4px 3px 0px #fff, 9px 8px 0px rgba(0,0,0,0.15);"></i>
		...
		<div class="tm-main-content">
			...
			<a href="insert.jsp" class="button add">Aggiungi elemento</a> 
					...
					<table border="1" cellpadding="5">
						...
						<c:forEach var="row" items="${listUsers.rows}">
							<tr>
								...
								<td><a href="edit.jsp?idcoffee=<c:out value="${row.idcoffee}"/>"><img
										src="img/edit.png"></a></td>
								<td><a href="javascript:confirmGo('Vuoi davvero eliminare questo dato?','deletedb.jsp?idcoffee=<c:out value="${row.idcoffee}"/>')"><img
										src="img/clear.png"></a></td>
							</tr>
						</c:forEach>
					</table>
					</div>
